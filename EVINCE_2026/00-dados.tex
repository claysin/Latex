...
\titulo{Técnicas para otimização e implementação de filtros FIR aplicados para saturação de DPD de bandas múltiplas concorrentes
\vspace{-3 cm}
}
...
Método de Powell; Saturação; Coeficientes}
